...
------------- REIVEW 리뷰 -------------
INSERT INTO REVIEW(REVIEW_NO, RES_NO, USER_NO, REVIEW_CONTENT, STAR, CREATE_DATE, STATUS, GOOD, COUNT)
            VALUES(SEQ_RVNO.NEXTVAL, 1201, 1, '굿입니다. 아주 굿이다.', 5, SYSDATE, 'Y', 'N', 0);

INSERT INTO REVIEW(REVIEW_NO, RES_NO, USER_NO, REVIEW_CONTENT, STAR, CREATE_DATE, STATUS, GOOD, COUNT)
            VALUES(SEQ_RVNO.NEXTVAL, 1201, 2,  '머리카락ㅡㅡ나왔어요. 위생별로인듯', 1, SYSDATE, 'Y', 'N', 0);

INSERT INTO REVIEW(REVIEW_NO, RES_NO, USER_NO, REVIEW_CONTENT, STAR, CREATE_DATE, STATUS, GOOD, COUNT)
            VALUES(SEQ_RVNO.NEXTVAL, 1201, 3, '정말 맛집입니다. 재방문 의사 100', 4, SYSDATE, 'Y', 'N', 0);
