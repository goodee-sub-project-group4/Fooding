...
, '2023/02/01', '12:30', 2, 'nice@gmail.com', NULL, 'C', SYSDATE, SYSDATE);
...
--2번주문
INSERT INTO BOOK_MENU VALUES (SEQ_BMNO.NEXTVAL, 2, 1, 1, 15000); 
--1번주문
INSERT INTO BOOK_MENU VALUES (SEQ_BMNO.NEXTVAL, 1, 2, 1, 18000); 
INSERT INTO BOOK_MENU VALUES (SEQ_BMNO.NEXTVAL, 1, 3, 3, 6000);

------------- PAYMENT 결제 -------------
INSERT INTO PAYMENT VALUES (SEQ_PMNO.NEXTVAL, 3, 1201, 3, 0, 37000, '신용카드', SYSDATE, 'Y'); 
INSERT INTO PAYMENT VALUES (SEQ_PMNO.NEXTVAL, 2, 1201, 3, 0, 15000, '신용카드', SYSDATE, 'Y');   
INSERT INTO PAYMENT VALUES (SEQ_PMNO.NEXTVAL, 1, 1201, 3, 0, 24000, '신용카드', SYSDATE, 'Y');   
