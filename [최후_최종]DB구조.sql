...
-- 유저 시퀀스
CREATE SEQUENCE SEQ_UNO START WITH 100 INCREMENT BY 1;
-- 업체 시퀀스
CREATE SEQUENCE SEQ_RESNO START WITH 1250 INCREMENT BY 1;
-- 리뷰 시퀀스
CREATE SEQUENCE SEQ_RVNO START WITH 100 INCREMENT BY 1;
-- 첨부파일 시퀀스
CREATE SEQUENCE SEQ_ATNO START WITH 100 INCREMENT BY 1;
-- 사이트 관리 시퀀스
CREATE SEQUENCE SEQ_SNO START WITH 100 INCREMENT BY 1;
-- 신고 시퀀스
CREATE SEQUENCE SEQ_BLNO START WITH 100 INCREMENT BY 1;
-- 공지사항 시퀀스
CREATE SEQUENCE SEQ_NONO START WITH 100 INCREMENT BY 1;
-- FAQ 시퀀스
CREATE SEQUENCE SEQ_FAQNO START WITH 100 INCREMENT BY 1;
-- 1대1 문의 시퀀스
CREATE SEQUENCE SEQ_QNO START WITH 100 INCREMENT BY 1;
-- 포인트 시퀀스
CREATE SEQUENCE SEQ_PNO START WITH 100 INCREMENT BY 1;
-- 결제 시퀀스
CREATE SEQUENCE SEQ_PMNO START WITH 100 INCREMENT BY 1;
-- 예약 시퀀스
CREATE SEQUENCE SEQ_BKNO START WITH 200 INCREMENT BY 1;
-- 예약 메뉴 시퀀스
CREATE SEQUENCE SEQ_BMNO START WITH 100 INCREMENT BY 1;
-- 정산 시퀀스
CREATE SEQUENCE SEQ_MTNO START WITH 100 INCREMENT BY 1;
-- 메뉴 시퀀스
