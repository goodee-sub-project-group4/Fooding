...
public class Restaurant {
	...
	public Restaurant(int resNo, String resName, String address, String dAddress, String phone, String rImg, String open,
			String close, String breakS, String breakE, double reviewAvg, int count) {
		super();
		this.resNo = resNo;
		this.resName = resName;
		this.address = address;
	...
	public Restaurant(String resName, String ceo, String permitNo, String address, String dAddress, String localCt,
			String dLocalCt, String phone, String cellphone, String email, String parking, String longtitude,
			String latitude, String open, String close, String breakS, String breakE, String foodCt) {
		super();
		this.resName = resName;
		this.ceo = ceo;
		this.permitNo = permitNo;
	...
	public Restaurant(String resName, String ceo, String permitNo, String address, String dAddress, String localCt,
			String dLocalCt, String phone, String cellphone, String email, String parking, String longtitude,
			String latitude, String open, String close, String breakS, String breakE, String foodCt, double reviewAvg) {
		super();
		this.resName = resName;
		this.ceo = ceo;
		this.permitNo = permitNo;
