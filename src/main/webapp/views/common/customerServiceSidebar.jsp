...
<!-- 제이쿼리구문 -->
    ...
    #content1-2 a {text-decoration:none; color:black;}
    ...
    <div class="wrap">
        <div id="content1-padding">
            <div id="content1">
                ...
                <div id="content1-2">
                    <div><a href="<%=request.getContextPath()%>/notice.me">공지사항</a><span class="arrow">></span></div>
                    <div><a href="">FAQ</a><span class="arrow">></span></div>
                    <div><a href="">1 : 1 문의</a><span class="arrow">></span></div> 
                </div>
            </div>
        </div>
    </div>
