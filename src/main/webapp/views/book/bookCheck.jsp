                ...
                <div>
                    ...
                    <div id="selectList-btn">
                        ...
                        <div style="height: 65px;">
                            <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#questionModal">문의하기</button>
                        </div>
                        <!-- 리뷰쓰기모달적용  -->
                        <div><button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#reviewModal">리뷰쓰기</button></div>
                    </div>
                </div>
            </div>
        </div>
